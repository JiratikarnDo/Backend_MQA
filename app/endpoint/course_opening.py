...
from schemas.course_opening import CourseOpeningCreate, CourseOpeningCreateDraft, CourseOpeningDetailResponse, CourseOpeningSummaryResponse, DeanActionRequest
...
async def submit_opening_request_draft(
